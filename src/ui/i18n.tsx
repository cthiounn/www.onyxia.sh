...
>()(
	...
	},
	{
		"en": {
			"App": {
				"install": "Install",
				"it is free software": ({ licenseUrl }) => <>Onyxia is free and open source software <MuiLink href={licenseUrl}>under MIT license</MuiLink></>,
				"pricing": "Pricing",
				"try it": "Try it",
...
The catalog of available images is not part of the app, you can create your own.`,
		...
		"fr": {
			"App": {
				"install": "Installer",
				"it is free software": ({ licenseUrl }) => <>Onyxia est un logiciel libre et open source <MuiLink href={licenseUrl}>sous licence MIT</MuiLink></>,
				"pricing": "Prix",
				"try it": "Demo",
